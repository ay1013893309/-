...
auc_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'auc_adasyn_result_on_'+classifier+'.csv', 'w', newline='')
auc_writer = csv.writer(auc_file)
auc_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

balance_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'balance_adasyn_result_on_'+classifier+'.csv', 'w', newline='')
balance_writer = csv.writer(balance_file)
balance_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

recall_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'recall_adasyn_result_on_'+classifier+'.csv', 'w', newline='')
recall_writer = csv.writer(recall_file)
recall_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

pf_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'pf_adasyn_result_on_'+classifier+'.csv', 'w', newline='')
pf_writer = csv.writer(pf_file)
pf_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max"])

brier_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'brier_adasyn_result_on_'+classifier+'.csv', 'w', newline='')
brier_writer = csv.writer(brier_file)
brier_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

mcc_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'mcc_adasyn_result_on_'+classifier+'.csv', 'w', newline='')
mcc_writer = csv.writer(mcc_file)
mcc_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

stable_auc_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'auc_stable_adasyn_result_on_'+classifier+'.csv', 'w',
              newline='')
stable_auc_writer = csv.writer(stable_auc_file)
stable_auc_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

stable_balance_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'balance_stable_adasyn_result_on_'+classifier+'.csv', 'w',
              newline='')
...
stable_recall_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'recall_stable_adasyn_result_on_'+classifier+'.csv', 'w',
              newline='')
...
stable_pf_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'pf_stable_adasyn_result_on_'+classifier+'.csv', 'w',
              newline='')
stable_pf_writer = csv.writer(stable_pf_file)
stable_pf_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

stable_brier_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'brier_stable_adasyn_result_on_'+classifier+'.csv', 'w',
              newline='')
...
stable_mcc_file = open('G:\pycharm\lutrs\stability-of-smote-main\\ant\\antvalue\\'+str(neighbor)+'mcc_stable_adasyn_result_on_'+classifier+'.csv', 'w',
              newline='')
